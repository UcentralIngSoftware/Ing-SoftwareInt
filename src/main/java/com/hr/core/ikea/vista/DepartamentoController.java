...
import com.hr.core.ikea.controlador.DepartamentoFacade;
...
public class DepartamentoController implements Serializable {
    ...
    @EJB
    private com.hr.core.ikea.controlador.DepartamentoFacade ejbFacade;
    ...
    public static class DepartamentoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Departamento) {
                ...
                return getStringKey(o.getDepaDepa());
            } else {
