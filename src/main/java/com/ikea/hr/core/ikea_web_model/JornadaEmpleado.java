 ...
 */
package com.ikea.hr.core.ikea_web_model;
 ...
 */
@Entity
@Table(name = "jornada_empleado", catalog = "ikea_bd", schema = "")
@XmlRootElement
@NamedQueries({
...
public class JornadaEmpleado implements Serializable {
    ...
    public String toString() {
        return "com.ikea.hr.core.ikea_web_model.JornadaEmpleado[ jornadaEmpleadoPK=" + jornadaEmpleadoPK + " ]";
    }
